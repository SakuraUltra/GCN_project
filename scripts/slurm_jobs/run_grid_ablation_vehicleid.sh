#!/bin/bash
# 批量提交VehicleID的grid scale实验 (8x8, 12x12, 16x16)

PROJECT_DIR="/users/sl3753/scratch/GCN_project"

echo "========================================"
echo "Submitting Grid Scale Experiments (VehicleID)"
echo "========================================"
...
for GRID_SIZE in 8x8 12x12 16x16; do
    ...
    BASE_DIR="${PROJECT_DIR}/outputs/grid_scale_1_1/${GRID_SIZE}/VehicleID"
    RUN_IDX=1
    ...
    sbatch <<EOF
#!/bin/bash
#SBATCH --job-name=grid_${GRID_SIZE}_vid
