...
def main():
    ...
    if args.grid_h > 0 and args.grid_w > 0:
        base_output_dir = os.path.join(f'./outputs/grid_scale/{args.grid_h}x{args.grid_w}', dataset_name)
    else:
        base_output_dir = os.path.join('./outputs/bot_baseline', dataset_name)
