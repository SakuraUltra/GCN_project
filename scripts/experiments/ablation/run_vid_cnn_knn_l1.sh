#!/bin/bash
#SBATCH --job-name=vid_cnn_knn_l1
#SBATCH --partition=gpuplus
#SBATCH --gres=gpu:h100:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=06:00:00
#SBATCH --output=logs/vid_cnn_knn_l1_%j.out
#SBATCH --error=logs/vid_cnn_knn_l1_%j.err

# VehicleID CNN+GCN kNN L1
echo "=========================================="
echo "Job: VehicleID CNN+GCN kNN L1"
