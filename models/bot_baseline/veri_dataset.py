...
class VehicleIDDataset(Dataset):
    ...
    def _parse_list(self, list_file):
        ...
        print(f"Loading VehicleID list from {list_file}...")
        ...
        for i, line in enumerate(lines):
            if i % 10000 == 0 and i > 0:
                print(f"  Processed {i}/{len(lines)} entries, {missing_count} missing...")
            ...
            if len(parts) >= 2:
                ...
                # Skip existence check for speed - will fail at training time if missing
